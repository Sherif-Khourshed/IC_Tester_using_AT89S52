...
void IC_74265();
void IC_4098();
int flag = 0; // if == 1 74265 If == 2 4098  if == 0 is a defected ic
int main()
{
	if(!OpenCom(5, 115200))
	{
	   ...
	   while(1){
		 ...
		 Sleep(1000);//wait for 1 second and then check for any update
		}
  ...
  void IC_4098()
  {
	   ...
	   clr(P0,3);
	   //reseting values of pin 6 and 10 by default it's high
	   setb(P0,5);
	   setb(P2,1);
